    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                @endif
                <h3>Printer Information - add</h3>
                <div style="font-size: 10px">
                    <form method="POST" action="/printer/addnewprinter" enctype="multipart/form-data">
                            ...
                            <div class="card card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input id="mac" type="text" class="form-control" name="mac" value=""><br>
                                        <label>Type</label>
