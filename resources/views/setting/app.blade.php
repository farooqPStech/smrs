                ...
                <h3>App Version</h3>
                  <div class="row">
                    <div class="card card-body">
                      ...
                      <a href="/setting/addapp" class="btn btn-smrs" style="width: 20%; float: right">Add New</a> 
                      </div><br>
                          ...
                          <?php if( !empty($app) ){ ?>
                            <?php foreach( $app as $item ){?>
                              <tr>
                                ...
                                <td align="center"><a href="/setting/editapp/{{$item->id}}" style="width: 90%" class="btn btn-smrs" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit text-white"> Edit</i></a><br><a href="/setting/setactive/{{$item->id}}" class="btn btn-warning" style="margin-top: 3%; width: 90%;" data-toggle="tooltip" data-placement="top" title="Remove"><i class="fa fa-edit text-white"> Set Active</i></a></td> 
                              </tr>
                            <?php }?>
                          <?php }?>
                        </tbody>
