...
<div class="row">
    <div class="col-md-12" >
        <h4>Report > Daily Sales Performance By Tariff</h4>
        <div class="card-body">
            @if (session('status'))
            ...
            @endif
                <h3>Daily Sales Performance By Tariff</h3>
                  <div class="row">
                      ...
                      <table id="allRoute" class="table table-bordered table-striped">
                        <thead class="table-smrs">
                          <tr class="column-filtering">
                            ...
                            <th>Consumption</th>
                            <th>Bill Amount</th>
                            <th>Average Consumption per Acc</th>
                          </tr>
                        </thead>
                        <br>
                      {{-- {{ $items->links() }} --}} 
...
<script type="text/javascript">
    $(document).ready( function () {
      var allRoute = $('#allRoute').DataTable({
          ...
          serverSide: true,
          ajax: {
          url:  "/report/dailysalesperformancebytarifftable",
          type: 'GET',
          },
          columns: [
