...
<div class="row">
    <div class="col-md-12" >
        <h4>Report > Billing Details By Amount</h4>
        <div class="card-body">
            @if (session('status'))
            ...
            @endif
                <h3>Billing Details By Amount</h3>
                  <div class="row">
...
<script type="text/javascript">
    $(document).ready( function () {
      var allRoute = $('#allRoute').DataTable({
              ...
              buttons: [
                  {
                      ...
                      className: 'btn-smrs',
                      title: function(){
                          return 'Billing Details By Amount (Resident)'
                      }
                  },
                  {
                      extend : 'excel',
          ...
          serverSide: true,
          ajax: {
          url:  "/report/billingdetailsbyamountresidenttable",
          type: 'GET',
          },
          columns: [
