...
<div class="row">
    <div class="col-md-12" >
        <h4>Report > Reading Interval Summary</h4>
        <div class="card-body">
            @if (session('status'))
            ...
            @endif
                <h3>Reading Interval Summary</h3>
                  <div class="row">
                    <div class="card card-body">
                        ...
                        <thead class="table-smrs">
                          <tr class="column-filtering">
                            ...
                            <th>Read Date</th>
                            <th>Total Account</th>
                            <th>Exceed Int (Min)</th>
                            <th>Average Exceed Int (Min)</th>
                          </tr>
                        </thead>
                        <br>
                      {{-- {{ $items->links() }} --}}
...
<script type="text/javascript">
    $(document).ready( function () {
      var allRoute = $('#allRoute').DataTable({
          ...
          serverSide: true,
          ajax: {
          url:  "/report/readingintervalsummarytable",
          type: 'GET',
          },
          columns: [
                 { data: 'id', name: 'id', 'visible': false},
                  ...
                  { data: 'exceed_int', name: 'sub' },
                  { data: 'everage_exceed_int', name: 'combine' },
              ],
          order: [[0, 'desc']],
