...
<div class="row">
    <div class="col-md-12" >
        <h4>Report > Meter Range Check</h4>
        <div class="card-body">
            @if (session('status'))
...
<script type="text/javascript">
    $(document).ready( function () {
      var allRoute = $('#allRoute').DataTable({
              ...
              buttons: [
                  {
                      ...
                      className: 'btn-smrs',
                      title: function(){
                          return 'Meter Range Check Report'
                      }
                  },
                  {
                      extend : 'excel',
          ...
          serverSide: true,
          ajax: {
          url:  "/report/meterrangechecktable",
          type: 'GET',
          },
          columns: [
                  ...
                  { data: 'consumer_number', name: 'consumer_number', 'visible': true},
                  { data: 'consumer_address_1', name: 'consumer_address_1', 'visible': true},
                  { data: 'meter_number', name: 'meter_number', 'visible': true},
                  { data: 'last_reading', name: 'last_reading', 'visible': true},
                  { data: 'high', name: 'high', 'visible': true},
                  { data: 'low', name: 'low', 'visible': true},
                  { data: 'reading', name: 'reading', 'visible': true},
                  { data: 'consumption', name: 'current', 'visible': true},
                  { data: 'code', name: 'daily_average_consumption', 'visible': true},
                  { data: 'mrid', name: 'tariff_code', 'visible': true},
                  { data: 'remark', name: 'current_bill_amount', 'visible': true},
              ],
          order: [[0, 'desc']],
