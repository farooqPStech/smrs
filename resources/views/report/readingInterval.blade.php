...
<script type="text/javascript">
    $(document).ready( function () {
      var allRoute = $('#allRoute').DataTable({
            ...
            buttons: [
                {
                    ...
                    className: 'btn-smrs',
                    title: function(){
                        return 'Reading Interval Report'
                    }
                },
                {
                    extend : 'excel',
          ...
          serverSide: true,
          ajax: {
          url:  "/report/readingintervaltable",
          type: 'GET',
          },
          columns: [
                  ...
                  { data: 'consumer_number', name: 'status' },
                  { data: 'consumer_address_1', name: 'sub' },
                  { data: 'time_1', name: 'address' },
                  { data: 'consumer_number_2', name: 'status' },
                  { data: 'consumer_address_1_2', name: 'sub' },
                  { data: 'time_2', name: 'address' },
                  { data: 'interval', name: 'address' },
              ],
          order: [[0, 'desc']],
