                ...
                <h3>Issue Code List</h3>
                  <div class="row">
                    <div class="card card-body">
                      ...
                      <a href="/setting/addissue" class="btn btn-smrs" style="width: 20%; float: right">Add New</a> 
                      </div><br>
