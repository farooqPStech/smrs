                ...
                <h3>Obstacle Code List</h3>
                  <div class="row">
                    <div class="card card-body">
                      ...
                      <a href="/setting/addobstacle" class="btn btn-smrs" style="width: 20%; float: right">Add New</a> 
                      </div><br>
                        ...
                        <tbody>
                          <?php if( !empty($obstacles) ){ ?>
                            <?php foreach( $obstacles as $obstacle ){?>
                              <tr>
                                <td>{{$obstacle->id}}</td>
                                <td>{{$obstacle->code_number}}</td>
                                <td>{{$obstacle->description}}</td>
                                <td>{{$obstacle->updated_at}}</td>
                                <td>{{$obstacle->updated_by}}</td>
                                <td align="center"><a href="/setting/editobstacle/{{$obstacle->id}}" style="width: 90%" class="btn btn-smrs" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit text-white"> Edit</i></a><br><a href="/setting/removeobstacle/{{$obstacle->id}}" class="btn btn-danger" style="margin-top: 3%; width: 90%;" data-toggle="tooltip" data-placement="top" title="Remove"><i class="fa fa-edit text-white"> Remove</i></a></td>  
                              </tr>
                            <?php }?>
                          <?php }?>
                        </tbody>
