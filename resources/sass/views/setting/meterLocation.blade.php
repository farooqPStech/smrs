                ...
                <h3>Meter Location List</h3>
                  <div class="row">
                    <div class="card card-body">
                      ...
                      <a href="/setting/addmeterlocation" class="btn btn-smrs" style="width: 20%; float: right">Add New</a> 
                      </div><br>
                      <table id="allRoute" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <?php if( !empty($meterLocation) ){ ?>
                            <?php foreach( $meterLocation as $meter ){?>
                              <tr>
                                <td>{{$meter->id}}</td>
                                <td>{{$meter->code_number}}</td>
                                <td>{{$meter->description}}</td>
                                <td>{{$meter->bill_code}}</td>
                                <td>{{$meter->updated_at}}</td>
                                <td>{{$meter->updated_by}}</td>
                                <td align="center"><a href="/setting/editmeterlocation/{{$meter->id}}" style="width: 90%" class="btn btn-smrs" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit text-white"> Edit</i></a><br><a href="/setting/removemeterlocation/{{$meter->id}}" class="btn btn-danger" style="margin-top: 3%; width: 90%;" data-toggle="tooltip" data-placement="top" title="Remove"><i class="fa fa-edit text-white"> Remove</i></a></td>  
                              </tr>
                            <?php }?>
                          <?php }?>
                        </tbody>
