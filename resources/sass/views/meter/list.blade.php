                      ...
                      <div class="tab">
                        <?php if( !empty($branches) ){ ?>
                            <?php foreach( $branches as $branch ){?>
                                    ...
                                    <button class="tabsublinks" onclick="openSubType(event, '{{$branch->name}}')" <?php if(auth()->user()->branch_id==$branch->id){ print ' id="subDefaultOpen" '; }?>>{{$branch->name}}</button>
...
// console.log(branches[i]['name']+'Table');
    ...
    function reject(readingId,userType,userId) {
        ...
        .then(value => {
            ...
            {
                // console.log(value)
                window.location.href = "/home/reject/" + readingId + "/" + userType + "/" + userId + "/" + value;
            }
            else
            {
                swal({
