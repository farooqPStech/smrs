...
<div class="row">
    <div class="col-md-12" >
        <h4>Report > Daily Sales Performance By Route</h4>
        <div class="card-body">
            @if (session('status'))
            ...
            @endif
                <h3>Daily Sales Performance By Route</h3>
                  <div class="row">
                      ...
                      <table id="allRoute" class="table table-bordered table-striped">
                        <thead class="table-smrs">
                          <tr class="column-filtering">
                            ...
                            <th>Total Acct</th>
                            <th>Total Read</th>
                            <th>Total No Access</th>
                            <th>Consumption</th>
                            <th>Bill Amount</th>
                            <th>Cancelled</th>  <!-- //end -->
                            <th>Average Cons Per Acc</th>
                          </tr>
                        </thead>
                        <br>
                      {{-- {{ $items->links() }} --}} 
...
<script type="text/javascript">
    $(document).ready( function () {
      var allRoute = $('#allRoute').DataTable({
          ...
          serverSide: true,
          ajax: {
          url:  "/report/dailysalesperformancebyroutetable",
          type: 'GET',
          },
          columns: [
