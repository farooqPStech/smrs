                      ...
                      <table id="allRoute" class="table table-bordered table-striped">
                        <thead class="table-smrs">
                          <tr class="column-filtering">
                            ...
                            <th>Average Consumption</th>  <!-- //end -->
                            <th>Tariff</th>
                            <th>Bill Code</th>
                            <th>Consumption Amount (RM)</th>
                            <th>B/Forward Amount (RM)</th>
                          </tr>
                        </thead>
                        <br>
                      {{-- {{ $items->links() }} --}} 
...
<script type="text/javascript">
    $(document).ready( function () {
      var allRoute = $('#allRoute').DataTable({
          ...
          serverSide: true,
          ajax: {
          url:  "/report/kivbilllistingtable",
          type: 'GET',
          },
          columns: [
